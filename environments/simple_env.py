...
def HSenv_test():
    env = SimpleHSEnv(skip_mulligan=True)
...
class HSsimulation(object):
    ...
    def __init__(self, skip_mulligan=False):
        ...
        self.player1 = Player("Agent", deck1, CardClass.WARRIOR.default_hero)
    ...
    def card_to_bow(self, card_obj):
        ...
        for k in sorted(card_dict.keys()):
            ...
            if isinstance(val, int):
                ...
                raise NotImplementedError("simple environments doesn't support complex cards")
